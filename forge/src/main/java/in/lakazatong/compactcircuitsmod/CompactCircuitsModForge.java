...
import in.lakazatong.compactcircuitsmod.platform.ForgeRegistryHelper;
...
@Mod(CompactCircuitsModCommon.MOD_ID)
public class CompactCircuitsModForge {

    public CompactCircuitsModForge(FMLJavaModLoadingContext context) {
