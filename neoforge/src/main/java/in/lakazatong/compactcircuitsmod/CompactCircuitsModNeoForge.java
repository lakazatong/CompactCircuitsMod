...
import in.lakazatong.compactcircuitsmod.platform.NeoForgeRegistryHelper;
...
public class CompactCircuitsModNeoForge {
    public CompactCircuitsModNeoForge(IEventBus bus) {
